...
class AppContainer(
    ...
    val deviceAuthorizationClient: DeviceAuthorizationClient = DeviceAuthorizationClient(),
    ...
    val sessionManager = SessionManager(sessionStore, login5Client, clientTokenClient, deviceAuthorizationClient)
